...
def main():
    for batch_size in TEST_BATCH_SIZES:
        ...
        with redirect_stdout(trap):
            ...
            _, _, datagen_test = dgv_cnn.create_datagen(
                top_path=top_path, sample=hparams, label_file=label_file, filter_hour_above=24
            )

            cnn_model = cnn.create_cnn(
                timestep_num, feature_num, hparams, datagen_test.label_scaler.scale_, snap_path=SNAP_PATH
            )
