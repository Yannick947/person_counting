...
def parse_args(args):
    ...
    parser.add_argument('--supercharge-crowdeds',   help='Flag whether files with crowded videos and many persons shall be used more often during training', action='store_true', default=False)
